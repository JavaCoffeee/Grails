...
<body>
	...
	<div id="show-book" class="content scaffold-show" role="main">
		...
		<ol class="property-list book">
			...
			<g:if test="${bookInstance?.about}">
				<li class="fieldcontain"><span id="about-label"
					class="property-label"><g:message code="book.about.label"
							default="About" /></span> <span class="property-value"
					aria-labelledby="about-label"><g:fieldValue
							bean="${bookInstance}" field="about" /></span></li>
			</g:if>
			...
			<g:if test="${bookInstance?.author}">
				<li class="fieldcontain"><span id="author-label"
					...
					aria-labelledby="author-label"><g:link controller="author"
							action="show" id="${bookInstance?.author?.id}">
							${bookInstance?.author?.name}
						</g:link></span></li>
			</g:if>

			<g:if test="${bookInstance?.imgPath}">
				<li class="fieldcontain"><span id="img-label"
					class="property-label"><g:message code="book.img.label"
							default="Img" /></span> <img
					src="${createLink(controller : 'book' , action:'loadImg' , id:"${bookInstance.id}")}"></img>
			...
			<g:if test="${bookInstance?.publisher}">
				<li class="fieldcontain"><span id="publisher-label"
					class="property-label"><g:message
							code="book.publisher.label" default="Publisher" /></span> <span
					class="property-value" aria-labelledby="publisher-label"><g:link
							controller="publisher" action="show"
							id="${bookInstance?.publisher?.id}">
							${bookInstance?.publisher?.name}
						</g:link></span></li>
			</g:if>
