		...
		<div id="list-author" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="contact" title="${message(code: 'author.contact.label', default: 'Contact')}" />
						...
						<g:sortableColumn property="about" title="${message(code: 'author.about.label', default: 'About')}" />
				...
				<g:each in="${authorInstanceList}" status="i" var="authorInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: authorInstance, field: "contact")}</td>
					
						<td>${fieldValue(bean: authorInstance, field: "email")}</td>
						
						<td>${fieldValue(bean: authorInstance, field: "address")}</td>
					
						<td>${fieldValue(bean: authorInstance, field: "about")}</td>
