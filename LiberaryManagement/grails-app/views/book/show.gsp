		...
		<div id="show-book" class="content scaffold-show" role="main">
			...
			<ol class="property-list book">
				...
				<li class="fieldcontain">
					<span id="about-label" class="property-label"><g:message code="book.about.label" default="About" /></span>
					
						<span class="property-value" aria-labelledby="about-label"><g:fieldValue bean="${bookInstance}" field="about"/></span>
				...
				<li class="fieldcontain">
					<span id="author-label" class="property-label"><g:message code="book.author.label" default="Author" /></span>
						...
						<span class="property-value" aria-labelledby="author-label"><g:link controller="author" action="show" id="${bookInstance?.author?.id}">${bookInstance?.author?.name}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="publisher-label" class="property-label"><g:message code="book.publisher.label" default="Publisher" /></span>
						...
						<span class="property-value" aria-labelledby="publisher-label"><g:link controller="publisher" action="show" id="${bookInstance?.publisher?.id}">${bookInstance?.publisher?.name}</g:link></span>
