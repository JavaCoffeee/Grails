		...
		<div id="list-publisher" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>						
						...
						<g:sortableColumn property="publishDate" title="${message(code: 'publisher.publishDate.label', default: 'Publish Date')}" />
						
						<g:sortableColumn property="about" title="${message(code: 'publisher.about.label', default: 'About')}" />
				...
				<g:each in="${publisherInstanceList}" status="i" var="publisherInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${publisherInstance.publishDate}" /></td>
						
						<td>${fieldValue(bean: publisherInstance, field: "about")}</td>
